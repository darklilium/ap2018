...
import { gLayerTramos } from '../../services/tramos_service';
import {
  gLayerMedidor,
  gLayerLuminarias,
  gLayerLumAsoc
} from '../../services/luminarias_service';
import { gLayerMedidor2 } from '../../services/medidores_service';
      ...
      <div className="muni-wrapper">
        ...
        <Sidebar.Pushable as={Segment} className="pushable_menu_wrapper">
          <Sidebar as={Menu} animation='push' direction='top' visible={visible} inverted className="pushable_menu_">
            ...
            <Menu.Item name='eraser' onClick={this.onClick}>
              <Icon name='erase' />
            </Menu.Item>
