...
import {selected_menu, toggle_visibility, toggle_segment, toggle_sidebar_visibility, busqueda, mapa, map_selector} from './muni/muni_reducer';


const reducer = combineReducers({
comunas, selected_comuna,
credentials, muniOptions, bottomMessageHandler,
selected_menu, toggle_visibility, toggle_segment, toggle_sidebar_visibility, busqueda, mapa, map_selector
});
